...
/**
 * Created by chenhs on 16/4/12.
 */
public class HSRLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = HSRLayout.class.getSimpleName();
        ...
        public void onAnimationEnd(Animation animation) {
            if (mRefreshing) {
                ...
                if (mScale) {
                    ...
                    setTargetOffsetTopAndBottom(mOriginalOffsetTop - mCurrentTargetOffsetLeft,
    ...
    public void setProgressViewOffset(boolean scale, int start, int end) {
        mScale = scale;
        mCircleView.setVisibility(View.GONE);
        mOriginalOffsetTop = mCurrentTargetOffsetLeft = start;
     ...
     * @param context
     */
    public HSRLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public HSRLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setRefreshing(boolean refreshing) {
        if (refreshing && mRefreshing != refreshing) {
            ...
            setTargetOffsetTopAndBottom(endTarget - mCurrentTargetOffsetLeft,
                    true /* requires update */);
            mNotify = false;
...
/// TODO: 2016/3/8
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!mUsingCustomStart && !mOriginalOffsetCalculated) {
            ...
            mCurrentTargetOffsetLeft = mOriginalOffsetTop = -mCircleView.getMeasuredHeight();
        }
        mCircleViewIndex = -1;
...
//        return MotionEventCompat.getY(ev, index);
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        setTargetOffsetTopAndBottom(targetY - mCurrentTargetOffsetLeft, true /* requires update */);
    }
...
//        mCurrentTargetOffsetLeft = mCircleView.getTop();
        mCurrentTargetOffsetLeft = mCircleView.getLeft();
